...
int tempoAuxSegundos;                       /*Variável utilizada para indicar cada segundo de execução*/
...
void task_yield ()
{
    ...
    /*Atualiza a quantidade de ativações do dispatcher*/
...
void task_resume (task_t *task)
{
    if(task){
        ...
        /*Insere a tarefa recebida na fila de prontas*/
        queue_append((queue_t**) &readyQueue, (queue_t*) task);
    }
}
...
int barrier_destroy (barrier_t *b)
{
    if(b){
        ...
        /*A fila aponta para nulo*/
        b->barrierQueue = NULL;

        /*A barreira aponta para nulo*/
        b = NULL;
        return 0;
    }
    return -1;
